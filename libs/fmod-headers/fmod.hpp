...
namespace FMOD
{
    ...
    */
    ...
    public:
        ...
        FMOD_RESULT F_API createDSPByType(FMOD_DSP_TYPE type, DSP** dsp) {
            return reinterpret_cast<FMOD_RESULT(__stdcall*)(FMOD::System*, FMOD_DSP_TYPE, DSP**)>(reinterpret_cast<uintptr_t>(GetModuleHandleA("fmod.dll")) + 0xbb140)(this, type, dsp);
        }
    ...
    */
    ...
    public:
        ...
        FMOD_RESULT F_API addDSP(int index, DSP* dsp) {
            return reinterpret_cast<FMOD_RESULT(__stdcall*)(FMOD::ChannelControl*, int, DSP*)>(reinterpret_cast<uintptr_t>(GetModuleHandleA("fmod.dll")) + 0xa330)(this, index, dsp);
        }
        FMOD_RESULT F_API removeDSP(DSP* dsp) {
            return reinterpret_cast<FMOD_RESULT(__stdcall*)(FMOD::ChannelControl*, DSP*)>(reinterpret_cast<uintptr_t>(GetModuleHandleA("fmod.dll")) + 0xa490)(this, dsp);
        }
    ...
    */
    ...
    public:
        ...
        FMOD_RESULT F_API setParameterFloat(int index, float value) {
            return reinterpret_cast<FMOD_RESULT(__stdcall*)(FMOD::DSP*, int, float)>(reinterpret_cast<uintptr_t>(GetModuleHandleA("fmod.dll")) + 0xaefd0)(this, index, value);
        }
    ...
    */
    ...
    public:
        ...
        FMOD_RESULT F_API setUserData(void* userdata);
        FMOD_RESULT F_API getUserData(void** userdata) {
            return reinterpret_cast<FMOD_RESULT(__stdcall*)(FMOD::DSPConnection*, void**)>(reinterpret_cast<uintptr_t>(GetModuleHandleA("fmod.dll")) + 0x69df0)(this, userdata);
        }
    };

...
void imgui_render() {
	...
	if (oneX) {
		...
		//	sequence_patch(gd::base + 0xe13c9, { 0x90, 0x90, 0x90, 0x90, 0x90, 0x90, 0x90, 0x90, 0x90 }); // m_landParticle
		//	sequence_patch(gd::base + 0xe13e0, { 0x90, 0x90, 0x90, 0x90, 0x90, 0x90, 0x90, 0x90, 0x90, 0x90, 0x90 }); // m_landParticle2
		//	sequence_patch(gd::base + 0xe13f9, { 0x90, 0x90, 0x90, 0x90, 0x90, 0x90, 0x90, 0x90, 0x90, 0x90, 0x90 }); // m_playerGroundParticles
		//	sequence_patch(gd::base + 0xe1412, { 0x90, 0x90, 0x90, 0x90, 0x90, 0x90, 0x90, 0x90, 0x90, 0x90, 0x90 }); // m_vehicleGroundParticles
		//	sequence_patch(gd::base + 0xe142b, { 0x90, 0x90, 0x90, 0x90, 0x90, 0x90, 0x90, 0x90, 0x90, 0x90, 0x90 }); // m_trailingParticles
		//	sequence_patch(gd::base + 0xe1444, { 0x90, 0x90, 0x90, 0x90, 0x90, 0x90, 0x90, 0x90, 0x90, 0x90, 0x90 }); // m_shipClickParticles
		//	sequence_patch(gd::base + 0xe145d, { 0x90, 0x90, 0x90, 0x90, 0x90, 0x90, 0x90, 0x90, 0x90, 0x90, 0x90 }); // m_ufoClickParticles
		//}
		//else {
		//	sequence_patch(gd::base + 0xe13c9, { 0x51, 0xf3, 0x0f, 0x11, 0x04, 0x24, 0xff, 0x50, 0x50 });
		//	sequence_patch(gd::base + 0xe13e0, { 0x51, 0xf3, 0x0f, 0x11, 0x04, 0x24, 0x8b, 0x01, 0xff, 0x50, 0x50 });
		//	sequence_patch(gd::base + 0xe13f9, { 0x51, 0xf3, 0x0f, 0x11, 0x04, 0x24, 0x8b, 0x01, 0xff, 0x50, 0x50 });
		//	sequence_patch(gd::base + 0xe1412, { 0x51, 0xf3, 0x0f, 0x11, 0x04, 0x24, 0x8b, 0x01, 0xff, 0x50, 0x50 });
		//	sequence_patch(gd::base + 0xe142b, { 0x51, 0xf3, 0x0f, 0x11, 0x04, 0x24, 0x8b, 0x01, 0xff, 0x50, 0x50 });
		//	sequence_patch(gd::base + 0xe1444, { 0x51, 0xf3, 0x0f, 0x11, 0x04, 0x24, 0x8b, 0x01, 0xff, 0x50, 0x50 });
		//	sequence_patch(gd::base + 0xe145d, { 0x51, 0xf3, 0x0f, 0x11, 0x04, 0x24, 0x8b, 0x01, 0xff, 0x50, 0x50 });
		//}
		...
		if (setting().onAbsolutePosition) {
			sequence_patch(gd::base + 0x4b49d, { 0x90, 0x8b, 0xcf, 0x90, 0x90, 0x90 }); // EditorUI::moveObject()
			sequence_patch(gd::base + 0x4be15, { 0x90, 0x8b, 0xcf, 0x90, 0x90, 0x90 }); // EditorUI::flipObjectsX()
			sequence_patch(gd::base + 0x4c205, { 0x90, 0x8b, 0xcf, 0x90, 0x90, 0x90 }); // EditorUI::flipObjectsY()
		}
		else {
			sequence_patch(gd::base + 0x4b49d, { 0x51, 0x8b, 0xcf, 0xff, 0x50, 0x5c });
			sequence_patch(gd::base + 0x4be15, { 0x51, 0x8b, 0xcf, 0xff, 0x56, 0x5c });
			sequence_patch(gd::base + 0x4c205, { 0x51, 0x8b, 0xcf, 0xff, 0x56, 0x5c });
		}
	...
	if (setting().show) {
		...
		if (ImGui::Begin("Cosmetic", nullptr, ImGuiWindowFlags_AlwaysAutoResize | ImGuiWindowFlags_NoResize | ImGuiWindowFlags_NoScrollbar)) {
			...
			ImGui::CheckboxF("Modern Particles", &setting().onModernParticles);
			ImGui::Tooltip("Makes mini particles follow the player correctly like in 2.1.");
		...
		if (ImGui::Begin("Creator", nullptr, ImGuiWindowFlags_AlwaysAutoResize | ImGuiWindowFlags_NoResize | ImGuiWindowFlags_NoScrollbar)) {
			...
			ImGui::Tooltip("Locks objects position for rotation/flipping.");

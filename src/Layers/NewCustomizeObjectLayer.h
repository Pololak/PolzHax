...
class NewCustomizeObjectLayer : public FLAlertLayer, ColorSelectDelegate {
protected:
	...
	SettingsColorObject* intToSettings(int);
...
public:
	...
	static NewCustomizeObjectLayer* create(GameObject* object, CCArray* objects) {

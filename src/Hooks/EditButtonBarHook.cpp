...
bool EditButtonBarHook::initH(EditButtonBar* self, CCArray* objs, CCPoint pos, int page, bool isObjects) {
    ...
    if (editorUI) {
        if (isObjects) {
            ...
            auto halfUp = editorUI->getSpriteButton("edit_upBtn2_001.png", menu_selector(EditorUI::moveObjectCall), nullptr, .9f);
            static_cast<ButtonSprite*>(halfUp->getChildren()->objectAtIndex(0))->addChild(halfLabel, 5);
            halfUp->setTag(103);
            objs->addObject(halfUp);

            auto halfDown = editorUI->getSpriteButton("edit_downBtn2_001.png", menu_selector(EditorUI::moveObjectCall), nullptr, .9f);
            static_cast<ButtonSprite*>(halfDown->getChildren()->objectAtIndex(0))->addChild(halfLabel, 5);
            halfDown->setTag(104);
            objs->addObject(halfDown);

            auto halfLeft = editorUI->getSpriteButton("edit_leftBtn2_001.png", menu_selector(EditorUI::moveObjectCall), nullptr, .9f);
            static_cast<ButtonSprite*>(halfLeft->getChildren()->objectAtIndex(0))->addChild(halfLabel, 5);
            halfLeft->setTag(101);
            objs->addObject(halfLeft);

            auto halfRight = editorUI->getSpriteButton("edit_rightBtn2_001.png", menu_selector(EditorUI::moveObjectCall), nullptr, .9f);
            ...
            auto quarterUp = editorUI->getSpriteButton("edit_upBtn2_001.png", menu_selector(EditorUI::moveObjectCall), nullptr, .9f);
            ...
            auto quarterDown = editorUI->getSpriteButton("edit_downBtn2_001.png", menu_selector(EditorUI::moveObjectCall), nullptr, .9f);
            ...
            auto quarterLeft = editorUI->getSpriteButton("edit_leftBtn2_001.png", menu_selector(EditorUI::moveObjectCall), nullptr, .9f);
            ...
            auto quarterRight = editorUI->getSpriteButton("edit_rightBtn2_001.png", menu_selector(EditorUI::moveObjectCall), nullptr, .9f);
            ...
            auto eightUp = editorUI->getSpriteButton("edit_upBtn2_001.png", menu_selector(EditorUI::moveObjectCall), nullptr, .9f);
            static_cast<ButtonSprite*>(eightUp->getChildren()->objectAtIndex(0))->addChild(eightLabel, 5);
            eightUp->setTag(111);
            objs->addObject(eightUp);

            auto eightDown = editorUI->getSpriteButton("edit_downBtn2_001.png", menu_selector(EditorUI::moveObjectCall), nullptr, .9f);
            ...
            auto eightLeft = editorUI->getSpriteButton("edit_leftBtn2_001.png", menu_selector(EditorUI::moveObjectCall), nullptr, .9f);
            ...
            auto eightRight = editorUI->getSpriteButton("edit_rightBtn2_001.png", menu_selector(EditorUI::moveObjectCall), nullptr, .9f);
            ...
            auto smallerUp = editorUI->getSpriteButton("edit_upBtn_001.png", menu_selector(EditorUI::moveObjectCall), nullptr, .9f);
            ...
            auto smallerDown = editorUI->getSpriteButton("edit_downBtn_001.png", menu_selector(EditorUI::moveObjectCall), nullptr, .9f);
            ...
            auto smallerLeft = editorUI->getSpriteButton("edit_leftBtn_001.png", menu_selector(EditorUI::moveObjectCall), nullptr, .9f);
            ...
            auto smallerRight = editorUI->getSpriteButton("edit_rightBtn_001.png", menu_selector(EditorUI::moveObjectCall), nullptr, .9f);
            ...
            auto unitUp = editorUI->getSpriteButton("edit_upBtn_001.png", menu_selector(EditorUI::moveObjectCall), nullptr, .9f);
            static_cast<ButtonSprite*>(unitUp->getChildren()->objectAtIndex(0))->addChild(unitLabel, 5);
            unitUp->setTag(119);
            objs->addObject(unitUp);

            auto unitDown = editorUI->getSpriteButton("edit_downBtn_001.png", menu_selector(EditorUI::moveObjectCall), nullptr, .9f);
            static_cast<ButtonSprite*>(unitDown->getChildren()->objectAtIndex(0))->addChild(unitLabel, 5);
            unitDown->setTag(120);
            objs->addObject(unitDown);

            auto unitLeft = editorUI->getSpriteButton("edit_leftBtn_001.png", menu_selector(EditorUI::moveObjectCall), nullptr, .9f);
            static_cast<ButtonSprite*>(unitLeft->getChildren()->objectAtIndex(0))->addChild(unitLabel, 5);
            unitLeft->setTag(117);
            objs->addObject(unitLeft);

            auto unitRight = editorUI->getSpriteButton("edit_rightBtn_001.png", menu_selector(EditorUI::moveObjectCall), nullptr, .9f);
            ...
            auto rotate45CW = editorUI->getSpriteButton("edit_cwBtn_001.png", menu_selector(EditorUI::transformObjectCall), nullptr, .9f);
            ...
            auto rotate45CCW = editorUI->getSpriteButton("edit_ccwBtn_001.png", menu_selector(EditorUI::transformObjectCall), nullptr, .9f);
            ...
            auto rotate26CW = editorUI->getSpriteButton("edit_cwBtn_001.png", menu_selector(EditorUI::transformObjectCall), nullptr, .9f);
            ...
            auto rotate26CCW = editorUI->getSpriteButton("edit_ccwBtn_001.png", menu_selector(EditorUI::transformObjectCall), nullptr, .9f);
    ...
    if (!EditButtonBarHook::init(self, objs, pos, page, isObjects)) return false;
    return true;
}

void EditButtonBarHook::mem_init() {
    HOOK("_ZN13EditButtonBar4initEPN7cocos2d7CCArrayENS0_7CCPointEib", EditButtonBarHook::initH, EditButtonBarHook::init);
}
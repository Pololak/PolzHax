...
void Hitboxes::drawTriangleObj(CCDrawNode* drawer, GameObject* ob, ccColor4F col) {
...
void Hitboxes::drawRectObj(CCDrawNode* drawer, GameObject* ob, ccColor4F col) {
    ob->updateOrientedBox();
...
void Hitboxes::drawCircleObj(CCDrawNode* drawer, GameObject* ob, ccColor4F col) {
    ob->updateOrientedBox();
...
void Hitboxes::drawPlayerHitbox(PlayerObject* player, CCDrawNode* drawNode)
{
...
void Hitboxes::drawSolidsObjectHitbox(GameObject* obj, CCDrawNode* drawNode) {
...
void Hitboxes::drawHazardsObjectHitbox(GameObject* obj, CCDrawNode* drawNode) {
    if ((obj->m_objectRadius > 0) && obj->m_objectType == GameObjectType::Hazard)
    ...
    else if (obj->m_objectType == GameObjectType::Hazard)
...
void Hitboxes::drawSpecialsObjectHitbox(GameObject* obj, CCDrawNode* drawNode) {
    switch (obj->m_objectType) {

	...
	if (ImGui::BeginPopupModal("Add Child")) {
		...
		if (ImGui::Button("Add")) {
			...
			case 4: {
				...
				_child = CCMenuItemSpriteExtra::create(sprite, sprite, nullptr, 0);
				break;
			}
			case 5: {
			...
			case 6: {
				ButtonSprite* child;
				child = ButtonSprite::create(text, buttonWidth, widthLimit, textScale, limitWidth, labelFont, buttonTexture, buttonHeight);
				_child = child;
				break;
			}
			}
